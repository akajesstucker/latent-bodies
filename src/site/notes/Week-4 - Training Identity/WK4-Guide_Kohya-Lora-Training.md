...
**If you do not have local GPU hardware, use the [[WK4-Guide_Civitai-Lora-Training|Civitai guide]] instead.** Cloud-hosted Kohya options are not reliably working at this time.
...
If you have many files to convert and prefer a scripted approach, see [[WK4-Guide_Kohya-File-Conversion|converting files with the command line]], then come back here.
